...
import { setSelectedItem } from "../redux/contentSlices";
...
const TvSeries = () => {
  ...
  const tvSeriesData = useSelector((state) => state.content.tvSeries);
  ...
  // Below code is to set searchData and tvSeriesData on TvSeries page display
  useEffect(() => {
    if (searchData && searchW.length > 0) {
      ...
      setDisplayItems(tvSeriesData);
    }
  }, [searchData, tvSeriesData, searchW]);
                ...
                <div className="grid grid-cols-1 ">
                  <div className="text-white ">
                    {searchDataLength > 0 ? (
                      ...
                      <h1 class="custom-heading">
                        <span class="gradient-text">TV Series</span>
                      </h1>
                    )}
