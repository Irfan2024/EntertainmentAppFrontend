...
const Bookmark = () => {
  console.log("Bookmark page  is clicked");
  ...
  const bookMarkItems = useSelector((state) => state.content.bookmarks); // for bookmarkItems list db
  ...
  const searchData = searchItems ? searchItems.message : null;
  ...
  // Below code is to dispatch  fetchBookmarks
  useEffect(() => {
    dispatch(fetchBookmarks())
  ...
  useEffect(() => {
    if (searchData && searchW.length > 0) {
      ...
      setDisplayItems(bookMarkItems);
    }
  }, [searchData, bookMarkItems, searchW]);
  ...
  const movieData = displayItems.filter((item) => item.movie_id);
  const tvSeriesData = displayItems.filter((item) => item.TvSeries_id);
          ...
          <div className="rinfo">
            ...
            >
              <svg
                ...
                fill={
                  bookMarkItems.find((item) => item._id === card._id)
                    ? "white"
                    : "none"
                }
              >
                  ...
                  {searchDataLength > 0 ? (
                    displayItems.length === 0 ? (
                      <div className="text-white ">
                        <h1 class="custom-heading">
                          <span class="gradient-text">{`We Found no result for "${searchW}" `}</span>
                        </h1>
                      </div>
                    ) : (
                      <div className="text-white ">
                    ...
                    <div className="text-white">
                      {movieData.length === 0 ? (
                        ...
                        <>
                          <h1 class="custom-heading">
                            <span class="gradient-text">Bookmarked Movies</span>
                          </h1>
                          <BookmarkedItems
                            items={movieData}
                            handleItemClick={handleItemClick}
                      ...
                      {tvSeriesData.length === 0 ? (
                        <h1 className="text-center">
                          You do not have any bookmarked TV series...
                        </h1>
                      ) : (
                        <>
                          <h1 class="custom-heading">
